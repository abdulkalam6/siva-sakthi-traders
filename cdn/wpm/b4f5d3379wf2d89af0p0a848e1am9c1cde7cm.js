(() => {
                    ...
                    var s = "function",
                        ...
                        Q = function(e, t) {
                            ...
                            return this.getBrowser = function() {
                                var e, t = {};
                                return t[p] = i, t[h] = i, G.call(t, r, y.browser), t[l] = typeof(e = t[h]) === u ? e.replace(/[^\d\.]/g, "").split(".")[0] : i, x && n && n.brave && typeof n.brave.isBrave == s && (t[p] = "Brave"), t
                            }, this.getCPU = function() {
                                var e = {};
                                return e[b] = i, G.call(e, r, y.cpu), e
                            }, this.getDevice = function() {
                                var e = {};
                                return e[m] = i, e[d] = i, e[f] = i, G.call(e, r, y.device), x && !e[f] && w && w.mobile && (e[f] = v), x && "Macintosh" == e[d] && n && typeof n.standalone !== a && n.maxTouchPoints && n.maxTouchPoints > 2 && (e[d] = "iPad", e[f] = g), e
                            }, this.getEngine = function() {
                                var e = {};
                                return e[p] = i, e[h] = i, G.call(e, r, y.engine), e
                            }, this.getOS = function() {
                                var e = {};
                                return e[p] = i, e[h] = i, G.call(e, r, y.os), x && !e[p] && w && "Unknown" != w.platform && (e[p] = w.platform.replace(/chrome os/i, V).replace(/macos/i, B)), e
    ...
    n.amdO = {}, n.n = e => {
        ...
        const e = "webPixelsManager",
            ...
            r = "0.0.475",
            o = "modern",
            i = "4f5d3379wf2d89af0p0a848e1am9c1cde7c",
            s = "b4f5d3379wf2d89af0p0a848e1am9c1cde7cm.js",
            a = "loggedConversion2",
            c = "WebPixel::Render",
        ...
        function E(e, t, n, r, o) {
            const i = ((null === (c = null === (u = m()) || void 0 === u ? void 0 : u.ShopifyAnalytics) || void 0 === c ? void 0 : c.meta) || {}).currency,
                s = {
        ...
        class R {
            ...
            static handleXhrDone(e) {
                try {
                    ...
                    R.ADD_TO_CART_REGEX.test(n) ? R.parsePayloadResponse(e, (t => {
                    ...
                    })) : R.CHANGE_TO_CART_REGEX.test(n) && R.parsePayloadResponse(e, (t => {
                        S(e.publish, t)
                    }))
                } catch (t) {
                    w("handleXhrDone", t)
            ...
            onReadyStateChange() {
                this.xhr.readyState === XMLHttpRequest.DONE && R.handleXhrDone({
                    method: this.method,
                    url: this.url,
                    body: this.body,
                    xhr: this.xhr,
        ...
        function P(e, t, n) {
            ...
            "function" == typeof r && (e.fetch = function(...e) {
                ...
                let s;
                return i.headers = new Headers(i.headers), (n && R.ADD_TO_CART_REGEX.test(String(e[0])) || R.CHANGE_TO_CART_REGEX.test(String(e[0])) || R.UPDATE_TO_CART_REGEX.test(String(e[0]))) && (s = N(), i.headers.set("X-Pixel-Event-ID", s), e[1] = i), r.apply(this, Array.prototype.slice.call(e)).then((e => {
                    if (!e.ok) return e;
                    const n = document.createElement("a");
                    n.href = e.url;
                    const r = n.pathname ? n.pathname : e.url;
                    try {
                        if (R.ADD_TO_CART_REGEX.test(r)) {
                            try {
                        ...
                        } else R.CHANGE_TO_CART_REGEX.test(r) && function(e) {
                            e.clone().json().then((e => {
                                S(t, e)
                            })).catch(o)
                        }(e)
        ...
        function D(e, t, n) {
            ...
            if (r && o.length > 0) return n[r] = n[r] || {}, void D(o.join("."), t, n[r]);
            const i = /(\w+)?\[(\d+)?\](.+)?/.exec(e);
            if (i) {
                const [e, r, o, s = ""] = i;
                if (r) return n[r] = n[r] || [], void D(e.replace(r, ""), t, n[r]);
                if (o) {
                    const e = s && "[" === s[0] ? [] : {};
                    return n[o] = n[o] || e, void D(s, t, n[o])
                }
                n.push(t)
            } else n[e] = t
        }
            ...
            ! function(e, t, n) {
                ...
                e.prototype.open = function(e, t) {
                    ...
                    if (!(e instanceof Document)) {
                        let r;
                        const o = String(this._url);
                        (n && R.ADD_TO_CART_REGEX.test(String(o)) || R.CHANGE_TO_CART_REGEX.test(String(o)) || R.UPDATE_TO_CART_REGEX.test(String(o))) && (r = N(), this.setRequestHeader("X-Pixel-Event-ID", r));
                        const i = new R(this, this._url, this._method, e || "", t);
                        this.addEventListener ? this.addEventListener("readystatechange", i.onReadyStateChange.bind(i), !1) : (i.oldOnReadyStateChange = this.onreadystatechange, this.onreadystatechange = i.onReadyStateChange)
                    }
                    o.call(this, e)
                }
            }(XMLHttpRequest, e, n), P(m(), e, n), v((n => {
                const r = n.getAttribute("action");
                r && r.indexOf("/cart/add") >= 0 && b(n, "submit", (n => {
                    ! function(e, t, n) {
        ...
        function M(e, t, n) {
            var r;
            null != n && n.logLevel && (r = n.logLevel, h = r), L(e, t, null == n ? void 0 : n.clientSideEventIDEnabled),
                function(e, t) {
                    v((n => {
                        const r = n.querySelector('[name="previous_step"]');
                        r && r instanceof HTMLInputElement && "payment_method" === r.value && b(document.body, "submit", (n => {
                            ! function(e, t, n) {
                                const r = t || window.event,
        ...
        R.ADD_TO_CART_REGEX = /^(?:\/[a-zA-Z]+(?:-[a-zA-Z]+)?)?\/cart\/add(?:\.js|\.json)?$/, R.CHANGE_TO_CART_REGEX = /^(?:\/[a-zA-Z]+(?:-[a-zA-Z]+)?)?\/cart\/change(?:\.js|\.json)?$/, R.UPDATE_TO_CART_REGEX = /^(?:\/[a-zA-Z]+(?:-[a-zA-Z]+)?)?\/cart\/update(?:\.js|\.json)?$/;
        const j = {
        ...
        function K(e) {
            return function(e) {
                ...
                for (let n = 0; n < t.length; n++) {
                    const [r, o] = t[n].split("=");
                    if (e === decodeURIComponent(r)) return JSON.parse(decodeURIComponent(o))
                }
            }(e)
        }
        ...
        function G(e, t, n, r) {
            if (!X(r)) throw new TypeError("Cookie value is not correctly URI encoded.");
            if (!X(e)) throw new TypeError("Cookie name is not correctly URI encoded.");
            let o = `${e}=${r}`;
        ...
        function J() {
            try {
                let e = function() {
                    const e = K(W);
                    if (void 0 !== e && (t = e).v === $ && function(e, t) {
                            const n = t.slice().sort();
                            return e.length === t.length && e.slice().sort().every(((e, t) => e === n[t]))
                        }(Object.keys(t).filter((e => "region" !== e && "lim" !== e && "cus" !== e && "reg" !== e)), H)) return e;
                    var t
                }();
                if (!e) return;
                return e
        ...
        function ne() {
            return Z(z.MARKETING)
        }

        function re() {
            return Z(z.SALE_OF_DATA)
        }
        ...
        function ce(e, t) {
            ...
            return fetch(`https://${o}/api/unstable/graphql.json`, s).then((e => {
                ...
                return G(W, a, o, u), G(Q, a, o, l), d && p && (G(ie, a, i, d), G(se, a, i, p)), c !== a && (G(W, c, o, u), G(Q, c, o, l), d && p && (G(ie, c, i, d), G(se, c, i, p))), void 0 !== e.granular_consent && function(e) {
                    const t = e[z.MARKETING],
                        n = e[z.SALE_OF_DATA],
                        r = e[z.ANALYTICS],
                        o = e[z.PREFERENCES];
                    !0 === t ? oe(j.MARKETING_ACCEPTED) : !1 === t && oe(j.MARKETING_DECLINED), !0 === n ? oe(j.SALE_OF_DATA_ACCEPTED) : !1 === n && oe(j.SALE_OF_DATA_DECLINED), !0 === r ? oe(j.ANALYTICS_ACCEPTED) : !1 === r && oe(j.ANALYTICS_DECLINED), !0 === o ? oe(j.PREFERENCES_ACCEPTED) : !1 === o && oe(j.PREFERENCES_DECLINED);
                    const i = function(e) {
                        return {
                            marketingAllowed: e[z.MARKETING],
                            saleOfDataAllowed: e[z.SALE_OF_DATA],
                            analyticsAllowed: e[z.ANALYTICS],
                            preferencesAllowed: e[z.PREFERENCES],
                            firstPartyMarketingAllowed: e[z.MARKETING],
                            thirdPartyMarketingAllowed: e[z.SALE_OF_DATA]
                        }
                    }(e);
                    oe(j.CONSENT_COLLECTED, i);
                    const s = [r, o, t, n];
                    s.every((e => !0 === e)) && oe(j.TRACKING_ACCEPTED), s.every((e => !1 === e)) && oe(j.TRACKING_DECLINED)
                }({
                    [z.PREFERENCES]: ee(),
                    [z.ANALYTICS]: te(),
                    [z.MARKETING]: ne(),
        ...
        function he(e, t) {
            return "object" == typeof e && e.headlessStorefront && !e.storefrontAccessToken ? (console.warn("Headless consent has been updated. Please read shopify.dev/docs/api/customer-privacy to integrate."), function(e, t) {
                function n(e, t = U.NO_VALUE) {
                    return !0 === e ? U.ACCEPTED : !1 === e ? U.DECLINED : t
                }
                const r = {
                        [F.ANALYTICS]: n(e[V.ANALYTICS], U.DECLINED),
                        [F.MARKETING]: n(e[V.MARKETING], U.DECLINED),
                        [F.PREFERENCES]: n(e[V.PREFERENCES], U.DECLINED),
                        [F.SALE_OF_DATA]: n(e[V.SALE_OF_DATA])
                    },
                    o = {
                        v: $,
                        reg: "",
                ...
                return G(W, e.rootDomain, Y, i), t(null), new Promise(((e, t) => {}))
            }(e, t || (() => {}))) : function(e, t) {
                if (function(e) {
                        ...
                        if ("object" == typeof e) {
                            ...
                            const n = [V.MARKETING, V.ANALYTICS, V.PREFERENCES, V.SALE_OF_DATA, V.EMAIL, B.ROOT_DOMAIN, B.CHECKOUT_ROOT_DOMAIN, B.STOREFRONT_ROOT_DOMAIN, B.STOREFRONT_ACCESS_TOKEN, B.HEADLESS_STOREFRONT, B.IS_EXTENSION_TOKEN, B.METAFIELDS];
                            for (const e of t)
                ...
                const r = function(e) {
                        return e ? ue() ? document.referrer : "" : null
                    }(n.analytics),
                    o = function(e) {
                        return e ? ue() ? window.location.pathname + window.location.search : "/" : null
                    }(n.analytics);
                return ce({
                    granular_consent: n,
                    ...null !== r && {
        ...
        function Se() {
            window.Shopify = window.Shopify || {}, window.Shopify.evids || (xe = {}, Ee = {
                [ge]: {},
                [ye]: {}
            }, window.Shopify.evids = (...e) => function(e, t) {
                if (! function(e) {
                        return ve.includes(e)
                    }(e) || (null == t ? void 0 : t.analyticsFramework) !== ye && (null == t ? void 0 : t.analyticsFramework) !== ge) return _e(we);
                ...
                return function(e, t, n) {
                    var r, o;
                    const i = null !== (r = xe[e]) && void 0 !== r ? r : xe[e] = {},
        ...
        class Ie {
            constructor({
                ...
                this.channelSubscribers = new Map, this.replayQueue = void 0, this.bufferSize = void 0, this.replayKeep = void 0, this.subscribeAllKey = void 0, this.eligibility = void 0, this.bufferSize = e, this.replayKeep = t, this.subscribeAllKey = n, this.replayQueue = new Te(e, t), this.eligibility = null != r ? r : Oe
            }
            publish(e, t, n = {}) {
                var r;
        ...
        class qe extends Error {
            constructor(...e) {
                super(...e), Error.captureStackTrace && Error.captureStackTrace(this, qe)
            }
        }
        const Ke = {
                            ...
                            try {
                                l = function(e, t) {
                                    ...
                                    if (e.stackTrace || e.stack || e.description) {
                                        ...
                                        if (t && t.length > 2 && (r.lineNumber = t[1], r.columnNumber = t[2], parseInt(r.lineNumber, 10) > 1e5)) throw new Be
                                    }
                                    return {
                                        errorClass: e ? .name || n,
                                        message: e ? .message || n,
            ...
            for (const n in e)
                if (Object.prototype.hasOwnProperty.call(e, n)) {
                    const r = n.replace(/[A-Z]/g, (e => `_${e}`)).toLowerCase(),
                        o = e[n];
                    t[r] = null !== o && "object" == typeof o ? We(o) : o
                }
            return t
        }
        ...
        const at = "/unstable/produce_batch",
            ct = 500;
        let ut = "wellKnown";
        const lt = new Array;
        let dt;
        ...
        function pt(e, t = !1) {
            const n = {
                ...
                payload: We(e.payload),
                metadata: {
                    event_created_at_ms: ht()
                }
            };
        ...
        function mt({
            ...
            lt.length = 0,
                function(e, t) {
                    ...
                    ! function(e, t) {
                        const n = `${{global:"https://monorail-edge.shopifysvc.com",wellKnown:`${it}/.well-known/shopify/monorail`,staging:"https://monorail-edge-staging.shopifycloud.com",test:"https://localhost"}[ut]}${at}`;
                        try {
        ...
        function Tt(e, t) {
            return e ? !t || Object.keys(e).every((n => !e[n] || t[n])) : le()
        }
        ...
        n(1412), n(1883), n(286);
        const Lt = () => (void 0 === Pt && (Pt = function() {
                let e = !1;
                try {
                    const t = {
                            get passive() {
        ...
        function jt(e, t, n, r = {}) {
            const o = r.addEventListenerOptions ? { ...Mt,
            ...
            try {
                ...
                return e.addEventListener(t, i, Lt() ? o : o.capture), () => {
        ...
        const Ut = new RegExp(["password", "pass", "pw", "ssn", "sin", "social", "security", "cc", "card", "creditcard", "cvv", "cvc", "cvn", "billing", "license", "health", "secret", "unique"].map((e => `^(.*[^a-z])?${e}([^a-z].*)?$`)).join("|"), "i"),
            zt = "******",
            Ft = ["SCRIPT", "IFRAME"],
            Vt = e => {
                if (!(e instanceof HTMLElement)) return !1;
                if (Ft.includes(e.tagName.toUpperCase()) || "exclude" === e.dataset.shopifyPrivacy || e.hidden) return !0;
                const t = e.parentElement;
                return !!t && Vt(t)
            },
            Bt = ["id", "name", "type"],
            Ht = e => e instanceof HTMLElement && "redact" === e.dataset.shopifyPrivacy || Bt.some((t => {
                const n = e.getAttribute(t);
                return "string" == typeof n && n.match(Ut)
            })),
            qt = (e, t) => ("value" in t && "string" == typeof t.value && Ht(e) && (t.value = zt), t),
        ...
        const Jt = ["screenX", "screenY", "pageX", "pageY", "offsetX", "offsetY", "movementX", "movementY"],
        ...
        function sn(e) {
            const t = {
                nodeType: e.nodeType,
                serializationId: tn(e)
            };
            if (e instanceof Element) {
                t.attributes = Xt(e, [...e.getAttributeNames(), "value"]), t.tagName = e.tagName;
                const {
                    x: n,
                    y: r,
                    height: o,
            ...
            return e.nodeType === Node.TEXT_NODE && (t.textContent = e.textContent ? ? ""), t
        }
        ...
        const cn = [HTMLInputElement, HTMLSelectElement, HTMLTextAreaElement, HTMLButtonElement],
        ...
        const dn = (e, t) => (n, {
                ...
                const o = e ? .target;
                (o instanceof HTMLInputElement || o instanceof HTMLSelectElement || o instanceof HTMLTextAreaElement) && !Vt(o) && (r ? n(`${r}${t}`, {
                    element: sn(o)
                }) : n(t, {
                    element: ln(o)
                }))
        ...
        n(9661);
        const hn = (e, t) => Array.from(e).reduce(((e, n) => (Vt(n) || e.push(t(n)), e)), []),
            bn = e => ({
                element: sn(e),
            ...
            vn = [pn, mn, (e, {
                eventPrefix: t
            } = {}) => jt(self.window, "click", (n => {
                const r = n ? .target;
                if (!(r instanceof Element) || Vt(r)) return;
                const o = t ? an(n, r) : function(e, t) {
                    return {
                        element: Yt(t),
                        ...Qt,
                        ...$t(e, Jt)
                ...
                const r = n ? .target;
                r instanceof HTMLFormElement && !Vt(r) && (t ? e(`${t}form_submitted`, {
                    element: bn(r)
                }) : e("form_submitted", {
                    element: { ...Xt(r, wn),
                        elements: Array.from(r.elements).filter((e => cn.some((t => e instanceof t)) && !Vt(e))).map((e => ln(e)))
                    }
                }))
            }))],
            gn = (e, t) => {
        ...
        const xn = {
            ...
            _n = e => null === e ? xn.null : void 0 === e ? xn.undefined : Object.prototype.toString.call(e);
        ...
        function Sn(e) {
            ...
            return void 0 === e || r(e) ? {
                isValid: function e(o, i = "root") {
                    ...
                    const s = _n(o),
                        a = En.includes(s);
                    return a || (n = i, t = `Value of type "${s}" at "${n}" must be one of the following types: ${En.join(", ")}.`), a
                }(e, "root"),
                error: t,
                errorKey: n
            } : (n = "root", t = `Value of type "${_n(e)}" at "${n}" must be an object.`, {
                isValid: !1,
                error: t,
                errorKey: n
            })
        ...
        function Hn(e) {
            ...
            function o(t, n) {
                if ("object" == typeof t) {
                    ...
                    if (Vn(t)) return Object.keys(t).reduce(((e, r) => ({ ...e,
                        [r]: o(t[r], n)
                    })), {})
                }
                return t
        ...
        function Jn(e, {
            ...
            return i.addEventListener("message", d), {
                ...
                terminate() {
                    l(Xn, void 0), m(), i.terminate && i.terminate()
                }
            };
        ...
        const rr = "webPixelDebug",
            or = "Session storage is not available. The Pixel Helper experience may be degraded.";
        ...
        function ar(e) {
            ! function(e) {
                if (!Tn()) return t = or, void(tr.has(t) || (tr.add(t), "console" in self && console.warn(t)));
                var t;
                const n = function(e) {
                    try {
        ...
        async function fr({
            ...
            if (s) {
                if (t.privileges) {
                    if (! function(e) {
                            return "sandbox" in e
                        }(i)) throw new qe("browser does not support the sandbox attribute on IFrames");
        ...
        async function mr({
                    ...
                    return fr({
                        containerSpec: {
                            ...
                            styles: { ...r ? {
                                ...
                                transition: `opacity ${Rn}ms ease-in-out, height ${Nn}ms ease-in-out, top ${Nn}ms ease-in-out, box-shadow ${In}ms`
                            },
                            dataset: {
            ...
            return r.expose({ ...hr(n, t)
                }),
                function(e) {
                    if (e.querySelector(`#${cr}`)) return;
                    const t = document.createElement("div");
                    var n;
                    t.setAttribute("id", cr), er(t, {
                        display: "block",
                        position: "absolute",
                        cursor: "grab",
                        background: "transparent",
                        ...
                        return e => {
                            e.preventDefault(), n[3] = e.clientX, n[4] = e.clientY, self.addEventListener("mouseup", o), self.addEventListener("mousemove", r), er(t, lr, {
                                important: !0
                            })
                        }
                    }(n, {
        ...
        function hr(e, t) {
            return {
                async setHelperReady() {
                    e.container.showPopover(), er(e.container, {
                        visibility: "visible",
                        opacity: "1"
                    }, {
                        important: !0
                ...
                async proceedWithoutConsent() {
                    try {
                        const {
                            success: e
                        } = await he(At.reduce(((e, t) => (e[t] = !0, e)), {}));
                        return Boolean(e)
                    } catch (e) {
                        return !1
                    }
                        ...
                        if (function(e, t) {
                            ...
                            mr({
                                ...
                                t && (this.endpoint = t, this.message("initializeHelper", {
                                    ...
                                    pixelName: i.name || "",
                                    config: e,
                                    collapsed: n.height <= On,
                                    loggerLevel: An() && "true" === self.localStorage.getItem("pixel-helper-advanced") ? br.Advanced : br.Standard
        ...
        const kr = e => ({ ...e,
            ...
            context: Sr(),
            id: "string" == typeof e.id && e.id.length > 0 ? e.id : N()
        });
        const Cr = "all_standard_events",
            Ar = "all_custom_events",
            Tr = "all_dom_events",
            Or = "all_error_events",
            Ir = ["application_error", "ui_extension_error"];
        ...
        function Rr(e) {
            ...
            return {
                publish(n, i, c) {
                    ...
                    if (Ir.includes(n) && !Ce("a545847e")) return !1;
                    if ("checkout_completed" === n && yn() && "1" === xt(document.cookie)[a]) return !1;
                    const l = Sn(i);
                    ...
                    return ft("eventPublish", {
                        ...
                        }(n), u || (u = !0, f = e.shopId, m = e.surface || Me.Unknown, It.add((() => function(e, t) {
                            Et || (Et = !0, ft("consentAccepted", {
                                version: r,
                                bundleTarget: o,
                                shopId: e,
                                surface: t,
                        ...
                        }(f, m)))), d.type === Ne.Error ? s.publish(d.name, d) : t.publish(d.name, d);
                    var f, m
                },
                ...
                publishDomEvent(e, t, n) {
                    if ("string" != typeof e) {
                        ...
                        throw new Nr(`Expected event name "${t}" to be a string, but got ${typeof e}`)
                    }
                    if (!Er(e) && !_r(e)) throw new Nr(`Event name "${e}" is not a supported DOM Event`);
                    if (_r(e) && !Ce(Ae)) return !1;
                    const r = Sn(t);
                    if (!r.isValid) throw new Nr(`Input Validation Error for event ${e}: ${r.error}\nPayload: ${JSON.stringify(t)}`);
                ...
                subscribe(a, u, l = {}) {
                    const d = N(),
                        p = async t => {
                            if (e.surface === Me.CheckoutOneSdk && l.scope !== $e.CheckoutOneSdk) return;
                            const n = {
                            ...
                            if (c !== Ne.Dom) {
                                let e;
                                yr(t.name) && (e = t ? .data ? .checkout ? .token), ft("subscriberEventEmit", { ...p,
                                    eventType: c,
                                    checkoutToken: e || void 0,
                                    status: f,
                                    errorMessage: m
                                })
                            } else ze(1) && ft("subscriberEventEmitDom", { ...p,
                                status: f,
                                errorMessage: m
                            })
                        };
                    ...
                    return a === Ar ? n.subscribe(Ar, p, l) : a === Cr || yr(a) ? t.subscribe(a, p, l) : a === Tr || Er(a) ? i.subscribe(a, p, l) : a === Or || xr(a) ? s.subscribe(a, p, l) : n.subscribe(a, p, l)
                }
            }
        }
        ...
        function Mr() {
            ...
            return n.reverse().reduce(((e, t) => {
                ...
                return function(e) {
                    ...
                    }(n), document.cookie.split(";").find((e => e.includes(Dr))) || r.push(n),
                    function(e) {
        ...
        function jr({
            ...
            const c = function(e) {
                return e === Me.Shopify || e === Me.CheckoutOne || e === Me.CheckoutOneSdk ? je.Checkout : e === Me.StorefrontRenderer ? je.Storefront : je.Unknown
            }(o);
            var u, l, d, p;
            return {
                analytics: {
                    subscribe: (t, i, a) => (s && zn(i), e.subscribe(t, i, { ...a,
                ...
                browser: {
                    cookie: {
                        get: async e => e ? xt(document.cookie)[e] ? ? "" : document.cookie,
                        set: async (e, t) => {
                            if (t) {
                                const n = `${e}=${t}`;
                                document.cookie = n
                    ...
                    localStorage: {
                        setItem: async (e, t) => An() ? window.localStorage.setItem(e, t) : Promise.resolve(),
                        getItem: async e => An() ? window.localStorage.getItem(e) : Promise.resolve(null),
                        key: async e => An() ? window.localStorage.key(e) : Promise.resolve(null),
                        removeItem: async e => An() ? window.localStorage.removeItem(e) : Promise.resolve(),
                        clear: async () => An() ? window.localStorage.clear() : Promise.resolve(),
                        length: async () => An() ? window.localStorage.length : Promise.resolve(0)
                    },
                    sessionStorage: {
                        setItem: async (e, t) => Tn() ? window.sessionStorage.setItem(e, t) : Promise.resolve(),
                        getItem: async e => Tn() ? window.sessionStorage.getItem(e) : Promise.resolve(null),
                        key: async e => Tn() ? window.sessionStorage.key(e) : Promise.resolve(null),
                        removeItem: async e => Tn() ? window.sessionStorage.removeItem(e) : Promise.resolve(),
                        clear: async () => Tn() ? window.sessionStorage.clear() : Promise.resolve(),
                        length: async () => Tn() ? window.sessionStorage.length : Promise.resolve(0)
                    }
                },
                settings: a,
                init: (u = i, {
                    ...
                    customerPrivacy: {
                        analyticsProcessingAllowed: pe(),
                        marketingAllowed: de(),
                        preferencesProcessingAllowed: fe(),
                ...
                customerPrivacy: {
                    subscribe: (e, i, a) => (s && zn(i), t.subscribe(e, i, { ...a,
                        pixelRuntimeConfig: n,
                        shopId: r,
                        surface: o,
                        scope: $e.WebPixelExtension
        ...
        async function Gr(t) {
            ...
            if (a.runtimeContext === De.Open && !Ce("5de24938")) return !1;
            var h, b;
            switch (a.restrictions || (a.restrictions = function(e, t) {
                ...
                await Ot(function(e) {
                    if (e) return At.reduce(((t, n) => (t[n] = e.includes(n.toUpperCase()), t)), {})
                }(a.privacyPurposes)), wr.message("logConsentGranted", {
                    pixelUid: {
                        id: f,
                        type: a.type
                    }
                ...
                case De.Strict:
                    try {
                        n = await async function({
                            ...
                            switch (e.runtimeContext) {
                                case De.Strict:
                                    [d, p] = await async function({
                                        ...
                                        const r = t.id,
                                            s = [Ye(n), "/wpm", `@${i}`, `/web-pixel-${r}`, `@${t.scriptVersion}`, "/sandbox", `/worker.${o}.js`];
                                        ...
                                        const a = s.join(""),
                                            ...
                                            u = new Promise(((e, t) => {
                                                const n = e => {
                                                    c.removeEventListener("error", n), t(e ? .filename && e ? .lineno && e ? .message ? new zr(e.message, a) : new Error(`Failed to load web worker for pixel ${r} with url ${a}}`))
                                                };
                                ...
                                case De.Lax:
                                    [d, p] = await async function({
                                        ...
                                        const {
                                            search: r
                                        } = self.location, s = t.id, a = t.type.toLowerCase(), c = [Ye(n), "/wpm", `@${i}`, `/${a}`, `/web-pixel-${s}`, `@${t.scriptVersion}`, "/sandbox", `/${o}`, /\.(js|json|xml)$/.test(self.location.pathname) ? "" : self.location.pathname, r];
                                        if (n.match(/spin\.dev\/?/)) {
                                            const e = r.length ? "&" : "?";
                            ...
                            const w = e.runtimeContext === De.Lax ? Vr() : {
                                    localStorageItems: {},
                                    sessionStorageItems: {}
                                },
                                v = [f.call.initialize({
                    ...
                    try {
                        n = await async function({
                            ...
                            const w = a.match(/spin\.dev\/?/),
                                v = [Ye(a), `/wpm@${i}`, `/${t.type.toLocaleLowerCase()}`, `/web-pixel-${m}@${t.scriptVersion}`, `/pixel.${o}.js`, w ? "?fast_storefront_renderer=1" : ""].join("");
                            if (!("createShopifyExtend" in (self[e] ? ? {}))) {
                                const t = (e, t) => {
                                    const n = Xr.get(`${e}-${t}`.toLowerCase());
            ...
            s && !n ? wr.message("logPixelRegister", {
                pixelUid: {
                    id: f,
                    type: a.type
                },
                status: "FAIL",
                errorType: s instanceof Hr ? "PixelInitializationError" : "PixelRegistrationError",
                error: s
            }) : n && wr.message("logPixelRegister", {
                pixelUid: {
                    id: f,
                    type: a.type
                },
        ...
        const Yr = [e => {
                let t = null;
                return jt(self.window, "mousemove", (n => {
                ...
                Vt(r) || e("dom_scroll", {
                    scrollingElement: sn(r)
                })
            }), {
                throttleDelay: 100
            }), e => {
                const t = [Wr("cut", e), Wr("paste", e), Wr("copy", e)];
                return () => {
                    t.forEach((e => e()))
                }
            }, e => jt(self.document, "selectionchange", (t => {
                const n = document.activeElement;
                if (!(n instanceof Element) || Vt(n)) return;
                let r = null;
                r = n instanceof HTMLInputElement || n instanceof HTMLTextAreaElement ? Ht(n) ? zt : n.value.substring(n.selectionStart || 0, n.selectionEnd || 0) : window.getSelection() ? .toString() || null, e("dom_selection_changed", {
                    value: r,
                    element: sn(n)
                })
            }), {
                ...
                return "loading" !== document.readyState ? (t(), () => {}) : jt(self.window, "DOMContentLoaded", t)
            }, e => {
                    ...
                    t.forEach((t => {
                        const n = hn(t.addedNodes, bn),
                            r = function(e) {
                                ...
                                return Vt(e.target) ? (e.removedNodes.forEach((e => on(e))), []) : hn(e.removedNodes, (e => {
                                    const t = bn(e);
                                    return on(e), t
                                }))
                            }(t),
                        ...
                        if ("attributes" === t.type && !Vt(t.target)) {
                            ...
                            n && e instanceof HTMLElement && t.oldValue !== e.getAttribute(n) && o.push(sn(t.target))
                        }
            ...
            Jr = function() {
                const e = self.Shopify ? .Checkout ? Me.Shopify : self.Shopify ? .analytics ? .replayQueue ? Me.StorefrontRenderer : Me.CheckoutOne,
                ...
                try {
                    const e = Dt();
                    return n.payload.status = "loaded", pt(n), {
                        init(n) {
                            ...
                            m = f, window.addEventListener("pagehide", (() => {
                                m.payload.pageDuration = Ze("page:session") ? .measurement ? .duration, pt(m), mt({
                                    skipXhr: !0
                                })
                            }));
                            const h = Rr(n),
                                b = function(e) {
                                    ...
                                    return {
                                        publish(e, n, r) {
                                            ...
                                            if (e !== j.CONSENT_COLLECTED) throw new Error(`Expected event name to be a ${j.CONSENT_COLLECTED}, but got "${e}".`);
                                            return t.publish(e, n, r)
                                        },
                                        subscribe(n, i, s = {}) {
                                            if (n !== j.CONSENT_COLLECTED) throw new Error(`Event name "${n}" is not supported in the CustomerPrivacyEventBus.`);
                                            return t.subscribe(n, (t => {
                                                if (e === Me.CheckoutOneSdk && s.scope !== $e.CheckoutOneSdk) return;
                                                const n = {
                                                ...
                                                i.call(t, t), ft("subscriberEventEmitPrivacy", {
                                                    version: r,
                                                    bundleTarget: o,
                                                    pageUrl: self.location.href,
                                                    shopId: s.shopId,
                            ...
                            try {
                                ...
                                if (/^web-pixel-sandbox/.test(self.name)) {
                                    const e = new qe("WebPixelsManager: browser library is being run in a sandbox");
                                    throw w.library = "browser", Ge.notify(e, w), e
                                }
                                if (!s) {
                                    const e = new qe("WebPixelsManager: shopId is required");
                                    throw Ge.notify(e, w), e
                                }
                                if (!d) {
                                    const e = new qe("WebPixelsManager: storefrontBaseUrl is required");
                                    throw Ge.notify(e, w), e
                                }
                                if (! function(e) {
                                        try {
                                    ...
                                    const e = new qe(`WebPixelsManager: storefrontBaseUrl is not a valid absolute URL: ${d}`);
                                    throw Ge.notify(e, w), e
                                }
                                ...
                                if (Promise.all(e.ready).then((() => function(e) {
                                    ...
                                    })), Promise.all(e.waiting).catch((() => {})), a !== Me.CheckoutOne && a !== Me.CheckoutOneSdk && (M(h.publish, c, {
                                        clientSideEventIDEnabled: Ce("19e54e9c")
                                    }), Ce("d04dc9f4") && gn(h.publishDomEvent.bind(h)), function() {
                                        if (!Ct) try {
                                            document.addEventListener(j.CONSENT_COLLECTED, kt), Ct = !0
                                        } catch (e) {
                                            Ge.notify(e, {
                                ...
                                const n = (g = {
                                    ...
                                    visitor: (e, t) => function(e, t, n) {
                                        ...
                                        if (!r.valid) throw new Nt(r.error || "Invalid input payload to visitorApi");
                                        const o = { ...e,
                                            ...t,
                                        ...
                                        return Ot({
                                            ...
                                            preferences: !1,
                                            sale_of_data: !1
                                        }).then((() => ft("visitor", o))).catch((() => Ge.notify("visitor error", {
                                            severity: "error",
                                ...
                                return {
                                    ...
                                    subscribe: (e, t, n) => h.subscribe(e, t, { ...n,
                                        shopId: s,
                                        surface: a,
                                        scope: a === Me.CheckoutOneSdk ? $e.CheckoutOneSdk : void 0
                                    }),
                                    visitor: (e, t) => n.visitor(e, t)
                                }
                            } catch (x) {
                                return x instanceof qe || Ge.notify(x, {
                                    context: "v0/init",
                                    shopId: s,
                                    initConfig: n
                                }), self.console && console.error(x), v.payload.status = "failed", v.payload.errorMsg = x ? .message, pt(v), f.payload.runtimeErrorCaught = "true", i
                            }
                            var g, y
                        }
                    }
                } catch (s) {
                    return s instanceof qe || Ge.notify(s, {
                        context: "v0/createWebPixelsManager"
                    }), self.console && console.error(s), n.payload.status = "manager-create-error", n.payload.errorMsg = s ? .message, pt(n, !0), {
                        init: () => i
                    }
                }
            }();
