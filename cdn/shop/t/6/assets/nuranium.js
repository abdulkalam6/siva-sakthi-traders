(function($) {
    ...
    var nuranium = {
        ...
        initCollectionPageLoadmore: function() {
            ...
            if (scroll__infitiny.length) {
                ...
                $(window).scroll(function() {
                    ...
                    var posTop =
                        collectionTop + collectionHeight - $(window).height();
                    if (
        ...
        ajaxCollectionPageLoadmoreMapData: function(data) {
            ...
            newProductCollection = newCollectionTemplate.find(
                ".product-collection"
            );
                ...
                tabLink.off("click").on("click", function(e) {
                    ...
                    if (!$(this).hasClass("active")) {
                        ...
                        if (
                            ...
                            var productGrid = $(
                                curTabContent.find(".collection-carousel")
                            );
        ...
        productItemSwatch: function() {
            $(document).on("change", ".selector-wrapper :radio", function(e) {
                ...
                switch (option_index) {
                    case 0:
                        ...
                        if (available_variants != undefined) {
                            ...
                            var alt_available_variants = variants.find(function(
                                variant
                            ) {
                                if (option_position == 1) {
                ...
                product_item
                    ...
                    .html(
                        Shopify.formatMoney(selected_variant.price, theme.moneyFormat)
                    );
                _self
                    ...
                    switch (option_index) {
                        case "option1":
                            ...
                            if (available_variants != undefined) {
                                ...
                                var altAvailableVariants = variants.find(function(
                                    variant
                                ) {
                    ...
                    if (self.data("with-one-option") != undefined) {
                        ...
                        if (comparePrice > price) {
                            product_item
                                .find("[data-compare-price-grid]")
                                .html(
                                    Shopify.formatMoney(comparePrice, theme.moneyFormat)
                                );
                        } else {
                            product_item.find("[data-compare-price-grid]").html("");
                        }
        ...
        checkStatusSwatch: function(product_item, item_swatch) {
            if (window.use_color_swatch) {
                    ...
                    switch (option_index) {
                        case 0:
                            item_el.each(function() {
                                ...
                                var option_unavailable = variants.find(function(
                                    variant
                                ) {
                                    if (opt_position == 1) {
                ...
                item_swatch
                    ...
                    .each(function() {
                        if (
                            $(this).find(".swatch-element").find("input:checked")
                            .length < 1
                        ) {
                    ...
                    switch (option_index) {
                        case 0:
                            swatch_el.each(function() {
                                ...
                                var opt1_soldout = variants.find(function(variant) {
                                    return (
                                        variant.option1 == swatch_val && variant.available
                                    );
                                });
                                if (opt1_soldout == undefined) {
                                    var option_unavailable = variants.find(function(
            ...
            $(document)
                ...
                .on("click.addOrRemoveWishlist", iconWishLists, function(e) {
                    ...
                    if (!self.hasClass("whislist-added")) {
                        ...
                        self.attr({
                            title: textremove,
                            "data-original-title": textremove,
                        });
            ...
            $(document)
                ...
                .on("click.addOrRemoveWishlist", iconWishLists, function(e) {
                    ...
                    if (!self.hasClass("whislist-added")) {
                        ...
                        self
                            .find(".wishlist-text")
                            .text(theme.strings.addto_wishlist);
                        if (
                            $('[data-wishlist-added="wishlist-' + productId + '"]')
                            .length
                        ) {
            ...
            jQuery.getJSON(
                ...
                function(product) {
                    ...
                    if (compare_at_price_min > price_min) {
                        ...
                        productHTML +=
                            "<span data-price-grid>" + price_min + "</span>";
                        productHTML += "</div>";
                    }
        ...
        initAddToCart: function(image, title) {
            $.ajax({
                ...
                success: function(data) {
                    $.magnificPopup.open({
                        items: {
                            src: '<div class="nov-with-anim product-quickview popup-quick-view cart__popup cart__popup_upsell"><div id="content_cart__popup_nt">' +
                                data +
                                "</div></div>",
                            type: "inline",
                        },
                ...
                complete: function() {
                    ...
                    if (title) {
                        var cartMessage =
                            ...
                            "</div>";
                        $(".cart__popup_content-message").prepend(cartMessage);
                    }
                },
                error: function() {
                    $(".loader").remove();
            ...
            $(document).on("click", ".btnProductQuickview", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $.magnificPopup.open({
                            items: {
                                src: '<div class="nov-with-anim popup-quick-view" id="content_quickview">' +
                                    data +
                            ...
                            callbacks: {
                                ...
                                open: function() {
                                    ...
                                    $(document).on(
                                        ...
                                        function() {
                                            $("#content_quickview .zmdi-close").trigger(
                                                "click"
                                            );
                                        }
                                    );
                ...
                fetch(product_url)
                    ...
                    .then((responseText) => {
                        ...
                        const element_variant_radio =
                            content_quickview.querySelector("product-variant-swatch");
                        if (element_variant_radio) {
                            content_quickview
                                .querySelector("product-variant-swatch")
                                .setAttribute("data--product-id", sectionId);
                        }

                        content_quickview
                            .querySelector(".product-template__container")
                            .setAttribute("data-section-id", sectionId);
                        content_quickview.querySelector(
                            ".product-template__container"
                        ).id = "ProductSection-" + sectionId;
                        content_quickview.querySelector(
                            "#ProductPrice-templateQV"
                        ).id = "ProductPrice-" + sectionId;
                        if (
                            content_quickview.querySelector("#ComparePrice-templateQV")
                        ) {
                            content_quickview.querySelector(
                                "#ComparePrice-templateQV"
                            ).id = "ComparePrice-" + sectionId;
                        }
                        ...
                        input =
                            content_quickview.querySelectorAll("input[type=radio]");
                                    ...
                                    if (t.length && r.length) {
                                        ...
                                        if (
                                            ...
                                            jQuery("[name=currencies]").length > 0 ?
                                                ...
                                                jQuery("#currencies span.selected")
                                                .length > 0 &&
                                                (i = jQuery(
